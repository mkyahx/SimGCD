...
#SBATCH --output=/userhome/cs/mkyahx/dev_outputs/asymmetric_a2_cars_repro_%j.out
#SBATCH --error=/userhome/cs/mkyahx/dev_outputs/asymmetric_a2_cars_repro_%j.err
...
for seed in 0 1 2; do
    PYTHONHASHSEED=$seed CUDA_VISIBLE_DEVICES=0 python train_asymmetric_a2_repro.py \
        ...
        --memax_weight 1 \
        --exp_name scars_asymmetric_a2_seed_${seed} \
        --seed $seed \
